  ...
  return (
    <>
      <SidebarProvider>
        ...
        <SidebarInset>
          <header className="sticky top-0 flex justify-between h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12 backdrop-blur-md  bg-opacity-80">
